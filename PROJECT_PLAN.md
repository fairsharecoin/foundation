...
- 2026-03-10: P2-004.1 draft complete: threat model document created at `docs/P2-004-THREAT-MODEL.md` with ranked risks, owners, and mitigation sequence.
- 2026-03-12: P2-004.2 complete: added CSRF verification matrix doc (`docs/P2-004.2-CSRF-VERIFICATION-MATRIX.md`) and expanded negative security tests to assert missing-CSRF rejection across all mutating endpoints plus explicit cross-origin POST blocking.
- 2026-03-12: P2-004.3 complete: introduced endpoint-specific dimensional rate budgets (`ip`/`account`/`device`) for key routes and added structured `rate_limit_hit` telemetry labels in audit output (`docs/P2-004.3-DIMENSIONAL-BUDGETS-TELEMETRY.md`).
- 2026-03-19: P2-004.4 complete: added baseline security-alert emission (`security_alert`) for login/CSRF/transfer/email-verification abuse signals, added CSRF + email-verification failure telemetry events, validated alert paths with synthetic end-to-end tests, and documented triage in `docs/P2-004.4-ALERTING-RUNBOOK.md`; build/tests green (21/21).
